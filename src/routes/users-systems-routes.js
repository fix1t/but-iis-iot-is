...
import { createRequest, usersSystem, requestsSystem, addUser, acceptRequest, rejectRequest, leaveSystem } from '../controllers/users-systems-controller.js';
...
router.post('/:id/join-request/:id', addUser);
